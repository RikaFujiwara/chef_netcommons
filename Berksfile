...
cookbook 'boilerplate', git: 'https://github.com/RikaFujiwara/chef_boilerplate.git'
cookbook 'boilerplate_php', git: 'https://github.com/RikaFujiwara/chef_boilerplate_php.git'
cookbook 'chef-dk'
